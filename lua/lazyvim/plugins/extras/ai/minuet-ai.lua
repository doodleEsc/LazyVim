return {
  {
    ...
    opts = function()
      local qwen_endpoint = LazyVim.env.get("QWEN_BASE_URL")
      local qwen_fim_model = LazyVim.env.get("QWEN_MODEL")

      local ds_endpoint = LazyVim.env.get("DS_BASE_URL")
      local ds_fim_model = LazyVim.env.get("DS_MODEL")
      ...
      return {
        ...
        provider_options = {
          ...
          openai_fim_compatible = {
            end_point = qwen_endpoint .. "/completions",
            api_key = "QWEN_API_KEY",
            name = "qwen",
            model = qwen_fim_model,
            stream = false,
            template = {
          ...
          -- -- deepseek
          -- openai_fim_compatible = {
          --   end_point = ds_endpoint .. "/completions",
          --   api_key = "DS_API_KEY",
          --   name = "deepseek",
          --   model = ds_fim_model,
          --   stream = false,
